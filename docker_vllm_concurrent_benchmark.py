#!/usr/bin/env python3
"""
vLLM Docker Container Concurrent Session Benchmark
Tests the performance of vLLM running in Docker with multiple concurrent requests
"""
...
def create_visualizations(all_stats: List[Dict], output_file: str = "docker_vllm_concurrent_benchmark.png"):
    """Create comprehensive visualization of benchmark results"""
    
    fig, axes = plt.subplots(2, 3, figsize=(18, 12))
    fig.suptitle('vLLM Docker Container - Concurrent Session Benchmark', fontsize=16, fontweight='bold')
    ...
    ax1.plot(concurrent_levels, avg_latencies, marker='o', linewidth=2, markersize=8, color='#2ecc71')
    ...
    colors = plt.cm.viridis(np.linspace(0.3, 0.9, len(concurrent_levels)))
    ...
    ax4.bar(x - width/2, total_requests, width, label='Total', color='#3498db', edgecolor='black', linewidth=1.5)
    ...
    ax5.plot(concurrent_levels, total_times, marker='o', linewidth=2, markersize=8, color='#e74c3c')
    ...
    ax6.plot(concurrent_levels, avg_tps, marker='o', linewidth=2, markersize=8, color='#9b59b6')
...
async def main():
    ...
    print("\n" + "="*60)
    print("vLLM Docker Container Concurrent Benchmark")
    print("="*60)
    ...
    if all_stats:
        ...
        output_json = "docker_vllm_benchmark_results.json"
